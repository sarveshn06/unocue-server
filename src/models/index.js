...
sequelize.models.tasks.hasMany(sequelize.models.program_module,{foreignKey: 'task_id'})
sequelize.models.program_module.belongsTo(sequelize.models.tasks, {foreignKey: 'task_id'});
