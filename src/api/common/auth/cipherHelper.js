...
function generateResponseTokens(user) {
  const normalizedUser = { id: user.id, role: user.role, email: user.email ,referral_code:user.referral_code,company_id:user.company_id,firstName:user.name,photo:user.photo,phone_number:user.phone_number};
